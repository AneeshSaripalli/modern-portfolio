import { Divider, Grid, makeStyles, Typography, Box, Avatar, Fade } from "@material-ui/core";
...
const About: React.FC<{}> = props => {
    ...
    return (
        <Grid direction="column" container justify="flex-start">
            <Grid container direction="row" item alignItems="center" justify="flex-start" className={clsx([classes.gridSection])}>
