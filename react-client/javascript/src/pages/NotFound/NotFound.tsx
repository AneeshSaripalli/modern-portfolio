...
const NotFound: React.FC<{}> = props => {
    ...
    return (
        <Grid direction="column" container justify="center" alignItems="flex-start" style={{ height: "100%" }}>
                ...
                <Fade in timeout={3000}>
                    <div>
                        <Typography variant="subtitle1" className={classes.subtitle}>
                            Maybe you'd find what you're looking for on the landing page?<br />
                        </Typography>
            ...
            <Grid item>
                <Link to="/" className={classes.link}>
                    <Button variant="text" className={clsx([classes.bounce, classes.routeBtn])}>
                        Jump to home!
                    </Button>
                </Link>
