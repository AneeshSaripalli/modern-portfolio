...
async function request_proto<IPayloadType, IResponseType>(
  path: string,
  payload: IPayloadType,
  decode: ProtoDecoder<IResponseType>
): Promise<IResponseType> {
  const encode: ProtoEncoder<IPayloadType> = Object.getPrototypeOf(payload)
    .constructor.encode;
